    ...
    model() {
      ...
      actions: {
        ...
        generateLibraries(volume) {
          ...
          this.controller.set('generateLibrariesInProgress', true);
          ...
          all(savedLibraries)
            .then(() => {
                this.controller.set('generateLibrariesInProgress', false);
              this.controller.set('libDone', true)
            });
        },
        ...
        deleteLibraries() {
          ...
          this._destroyAll(this.controller.get('libraries'))
        ...
        deleteBooksAndAuthors() {
          ...
          const authors = this.controller.get('authors');
          const books = this.controller.get('books');
